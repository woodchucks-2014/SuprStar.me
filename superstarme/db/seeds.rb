...
kai = User.create(name: "Kai", phone_number: "1234567890", party_id: 1)
ken = User.create(name: "Ken", phone_number: "1234567890", party_id: 1)
john = User.create(name: "John", phone_number: "1234567890", party_id: 1)

# Creating users for cicadas
jake = User.create(name: "Jake", phone_number: "1234567890", party_id: 2)
jess = User.create(name: "Jess", phone_number: "1234567890", party_id: 2)
danielle = User.create(name: "Danielle", phone_number: "1234567890", party_id: 2)
