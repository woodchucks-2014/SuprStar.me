...
party_1 = Party.create(name: "Woodchucks", hash_tag: "#woodchucks", queue: [])
#
...
p Comment.create(content: "awesome bro", user_id: 1, party_id: 1)
p Comment.create(content: "I love you", user_id: 1, party_id: 1)
p Comment.create(content: "i hate you", user_id: 1, party_id: 1)
p Comment.create(content: "thats beautiful", user_id: 1, party_id: 1)
p Comment.create(content: "fuck you", user_id: 1, party_id: 1)
